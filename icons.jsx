...
const Icon = ({ name, className = "icon" }) => {
  const paths = {
    ...
    google: <><path d="M21.35 11.1H12v3.8h5.35c-.5 2.4-2.55 3.8-5.35 3.8a6 6 0 1 1 4-10.45l2.7-2.7A9.5 9.5 0 1 0 12 21.5c5.5 0 9.5-3.85 9.5-9.5 0-.65-.05-1.3-.15-1.9z" fill="currentColor" stroke="none"/></>,
...
// ============== AVATAR ==============
const AVATAR_COLORS = ["#d97757", "#3b6e4f", "#3a6e9c", "#7a5ba0", "#b07f2b", "#c25e58"];
const Avatar = ({ name, size = "" }) => {
  const i = (name.charCodeAt(0) + (name.charCodeAt(1) || 0)) % AVATAR_COLORS.length;
  const initials = name.split(" ").map(n => n[0]).join("").slice(0, 2).toUpperCase();
  return (
    <div className={`avatar ${size}`} style={{ background: AVATAR_COLORS[i] }} title={name}>
      {initials}
    </div>
  );
};
